...
import (
	...
	cspx509 "github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/bccsp/x509"
)
...
func TestRegisterEnrollRevoke(t *testing.T) {
	...
	if adminUser == nil {
		...
		cert509, err := cspx509.ParseCertificate(certPem.Bytes)
		if err != nil {
